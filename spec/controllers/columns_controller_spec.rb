  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved column as @column" do
        ...
        post :create, {:column => { "name" => "invalid value" }}, valid_session
        assigns(:column).should be_a_new(Column)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested column" do
        ...
        Column.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => column.to_param, :column => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the column as @column" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Column.any_instance.stub(:save).and_return(false)
        put :update, {:id => column.to_param, :column => { "name" => "invalid value" }}, valid_session
        assigns(:column).should eq(column)
      end
